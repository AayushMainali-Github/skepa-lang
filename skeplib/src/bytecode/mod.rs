...
pub enum Instr {
    ...
    IntStackConstOpToLocal {
        slot: usize,
        stack_op: IntLocalConstOp,
        local_op: IntLocalConstOp,
        rhs: i64,
    },
    ...
    StructGetLocalSlotAddToLocal {
        struct_slot: usize,
        field_slot: usize,
        dst: usize,
    },
    StructFieldAddMulFieldModLocalToLocal {
        struct_slot: usize,
        arg_slot: usize,
        arg_op: IntLocalConstOp,
        arg_rhs: i64,

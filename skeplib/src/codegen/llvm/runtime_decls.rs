const RUNTIME_DECLS: &[(&str, &str)] = &[
    ...
    ("skp_rt_result_eq", "declare i1 @skp_rt_result_eq(ptr, ptr)"),
    (
    ...
    (
        "skp_rt_raise_negative_shift_count",
        "declare void @skp_rt_raise_negative_shift_count()",
    ),
    (
    ...
    (
        "skp_rt_value_from_result",
        "declare ptr @skp_rt_value_from_result(ptr)",
    ),
    (
    ...
    (
        "skp_rt_value_to_result",
        "declare ptr @skp_rt_value_to_result(ptr)",
    ),
    (
...
mod tests {
    ...
    fn runtime_declarations_are_unique_and_cover_core_abi_surface() {
        ...
        assert!(names.contains(&"skp_rt_raise_negative_shift_count"));
    }
}
